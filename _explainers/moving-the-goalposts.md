...
{% include explain-swap.html
   a_label="The standard, as stated"
   a="Show me one customer who actually asked for this."
   a_tone="cool"
   mid="After you show them four"
   mid_note="Four named accounts, with dates and ticket numbers."
   b_label="The standard, now"
   b="Sure, but none of those are enterprise customers."
   b_tone="warm"
   back="Produce two enterprise customers and the bar becomes “paying enterprise customers.”" %}

{% include explain-swap.html
   a_label="The standard, as stated"
   a="If the benchmark shows a real difference, I’ll drop it."
   a_tone="cool"
   mid="After the benchmark shows a real difference"
   b_label="The standard, now"
   b="Benchmarks never reflect production load anyway."
   b_tone="warm" %}
