...
aka: "strawmanning"
tagline: "Swap somebody’s actual argument for a dumber one, knock the dumb one down, and act like the job is finished."
tell: "The thing being demolished is not the thing that was said."
description: "A straw man replaces someone's real argument with a weaker or more extreme version that's easier to attack. What it looks like, why the refutation proves nothing, and how to shut it down in one sentence."
---

## The short version

You make an argument. They restate it as something more extreme, sloppier, or stupider than what you actually said — and then they refute *that*.

The refutation is often perfectly good. It's just aimed at a claim nobody made. Meanwhile your real argument is still standing there untouched, and you've now lost your turn to the business of saying "that isn't what I said," which sounds defensive and gets you nowhere.
...
{% include explain-swap.html
   a_label="What was said"
   a="I think we should test this release for another week."
   a_tone="cool"
   mid="What gets attacked"
   b_label="What it gets turned into"
   b="So you want to never ship anything."
   b_tone="warm" %}

{% include explain-swap.html
   a_label="What was said"
   a="The speed limit on that road is too low for the conditions."
   a_tone="cool"
   mid="What gets attacked"
   b_label="What it gets turned into"
   b="Great — no speed limits at all, let people die."
   b_tone="warm" %}

## Why it doesn't work

Because it refutes a claim nobody made. That part is obvious. The interesting question is why intelligent people do it constantly without noticing.
...
The counter to a straw man isn't a rule, it's a habit: restate the other person's argument in its *strongest* form, the version they'd sign their name to, and answer that one.

If you can't state their position well enough that they'd nod at it, you don't understand it yet, and anything you say next is aimed at a dummy. This is also the fastest way to win arguments you deserve to win — beating the strong version actually settles something.
