...
kind: "Thinking trap"
aka: "throwing good money after bad, the Concorde fallacy"
tagline: "The reason given for continuing is everything already spent — which is gone whatever happens next, and therefore cannot be a reason for anything."
tell: "The argument for going on is entirely about the past."
description: "Sunk costs are identical across every option, so they can’t choose between them. Why quitting feels like wasting what you spent, and the question that resets the decision."
---
...
{% include explain-swap.html
   a_label="What’s actually true"
   a="Two years in, the platform still doesn’t do the one thing it was for."
   a_tone="cool"
   mid="What gets concluded"
   mid_note="…on the strength of the two years."
   b_label="The decision"
   b="We can’t stop now. We’ve got two years in it."
   b_tone="warm" %}

{% include explain-swap.html
   a_label="What’s actually true"
   a="The film is dull and there are ninety minutes left."
   a_tone="cool"
   mid="What gets concluded"
   mid_note="…on the strength of the ticket price."
   b_label="The decision"
   b="I paid for this, I’m watching it."
   b_tone="warm" %}

{% include explain-swap.html
   a_label="What’s actually true"
   a="The course isn’t going anywhere I want to go."
   a_tone="cool"
   mid="What gets concluded"
   mid_note="…on the strength of the three years."
   b_label="The decision"
   b="I’m three years in. I have to finish."
   b_tone="warm" %}
