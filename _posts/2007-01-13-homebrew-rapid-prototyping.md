...
There are already a few other sites out there that boast they can do this - like <a target="_blank" href="http://www.fabathome.org/wiki/index.php?title=Main_Page">Fab@Home.org</a> and <a target="_blank" href="http://reprap.org/bin/view/Main/WebHome">RepRap.org</a> but their abilities are poor at best.. A long way from nothing, but an even longer way from something useful..  And considering its 2007 and we are supposed to have flying cars by now.. I don't think this is too tall of an order.

There must be a way to create some stereolithography or polyjet machine that could do the trick on a home scale.. If <a target="_blank" href="http://www.sears.com/carve">Sears can come up with a at home CNC carving machine</a>, then surely someone can come up with an at home fabrication device...
