---
title: "No, My Air Conditioner Is Not a Death Ray Pointed at France"
layout: post
date: 2026-07-01
...
Not because climate change is fake.
Not because the United States has no emissions problem.
Not because Americans are flawless stewards of energy.
...
<aside class="emit-band">
  <span class="emit-eyebrow">2024 greenhouse-gas emissions, flattened by land area</span>
  <div class="emit-scroll">
    <table class="emit-table">
      <thead>
        <tr>
          <th scope="col">Place</th>
          <th scope="col">2024 GHG emissions</th>
          <th scope="col">Land area</th>
          <th scope="col" class="emit-key">Emissions per km²</th>
        </tr>
      </thead>
      <tbody>
        <tr>
          <th scope="row">United States</th>
          <td>5.91B tons CO₂e</td>
          <td>9.15M km²</td>
          <td class="emit-key">~646 tons/km²</td>
        </tr>
        <tr>
          <th scope="row">France + Monaco</th>
          <td>378M tons CO₂e</td>
          <td>539K km²</td>
          <td class="emit-key emit-flag">~702 tons/km²</td>
        </tr>
        <tr>
          <th scope="row">EU27</th>
          <td>3.16B tons CO₂e</td>
          <td>4.0M km²</td>
          <td class="emit-key">~792 tons/km²</td>
        </tr>
        <tr class="emit-standout">
          <th scope="row">China</th>
          <td>15.54B tons CO₂e</td>
          <td>9.39M km²</td>
          <td class="emit-key">~1,655 tons/km²</td>
        </tr>
      </tbody>
    </table>
  </div>
  <span class="emit-source">Sources: EDGAR 2025 GHG report · World Bank land area</span>
</aside>
...
It's a "we treated air conditioning like vulgar American barbarism until the weather stopped cooperating" problem.
