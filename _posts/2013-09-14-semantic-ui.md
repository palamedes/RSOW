...
I have been a long time fan and user of [twitterbootstrap](http://twitter.github.io/bootstrap).  It's an extremely simple, yet powerful little framework for creating responsive front ends for web applications and it goes pretty far in removing a lot of the annoying things you have to do when creating user interfaces.
