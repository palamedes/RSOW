...
## Palamedes - [Historical Reference](/palamedes-historical-reference/)
...
I worked for IBM for 6 years as Senior UI Developer on Build Forge, plus positions with major companies including the Bill and Melinda Gates Foundation, Dun and Bradstreet, and Cox Media.

I now intentionally work for small startups in Austin, preferring that environment. My technical expertise spans Ruby, Rails, PHP, Zend, JavaScript, Java, AJAX, JSON, XSLT, XML, and comprehensive web development.
...
I decided to join the Army for 5 years as a 98CKP — for those of you who have no idea what that is, I was a signals intelligence analyst and a Korean linguist. The job sounded cool! It wasn't. Actually it was damn boring — I ended up fixing trucks in the motor pool more than anything.
...
Things are always better when you look back at them. Sometimes I can't believe how long ago it was; It seems like only yesterday - boy how time flies.
